...
/**
 * Helper alias for the Sha256Internal class.
 * @private
 */
type SourceData = string | ArrayBuffer | ArrayBufferView;
/**
 * Shim for the Sha256 class.
 * @private
 */
declare class Sha256Internal {
    constructor(secret?: SourceData);
    update(toHash: SourceData): void;
    digest(): Promise<Uint8Array>;
}
/**
 * Contains the set of internal utilities used.
 * @private
 */
interface SquareUtils {
    /**
     * An internal sha256 library used when `crypto.subtle.digest` does not exist.
     */
    Sha256?: typeof Sha256Internal;
}
/**
...
interface Square {
     ...
     * @throws {WebSdkEmbedError} The Web SDK instance cannot be embedded
     */
